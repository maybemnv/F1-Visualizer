...
handle_failure() {
    ...
    aws sns publish --topic-arn arn:aws:sns:us-east-2:637423600104:F1-Visualizer --message file://./Automation/start-server.log --subject "Start Server Failure - $error_line: $error_command"
}
