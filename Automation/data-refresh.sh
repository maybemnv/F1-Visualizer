...
handle_failure() {
    ...
    then
        ...
        git restore .
        aws sns publish --topic-arn arn:aws:sns:us-east-2:637423600104:F1-Visualizer --message file://./Automation/data-refresh.log --subject "Data Refresh Failure - preprocess"
    ...
    then
        ...
        aws sns publish --topic-arn arn:aws:sns:us-east-2:637423600104:F1-Visualizer --message file://./Automation/data-refresh.log --subject "Data Refresh Failure - readme_machine"
    elif [[ "$error_command" == *reddit_machine.py* ]]
    then
        # failure in Reddit publishing, release all other data and emit warning
        ./Automation/auto-push.exp -d 2>./Automation/auto-push.log
        aws sns publish --topic-arn arn:aws:sns:us-east-2:637423600104:F1-Visualizer --message file://./Automation/data-refresh.log --subject "Reddit Publication Warning"
    else
        aws sns publish --topic-arn arn:aws:sns:us-east-2:637423600104:F1-Visualizer --message file://./Automation/data-refresh.log --subject "Data Refresh Failure - $error_line: $error_command"
    fi
...
# relaunch dash app
./Automation/start-server.sh
aws sns publish --topic-arn arn:aws:sns:us-east-2:637423600104:F1-Visualizer --message file://./Automation/data-refresh.log --subject "Data Refresh Success - $UTC"
