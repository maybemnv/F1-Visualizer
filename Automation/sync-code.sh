...
handle_failure() {
    ...
    aws sns publish --topic-arn arn:aws:sns:us-east-2:637423600104:F1-Visualizer --message file://./Automation/sync-code.log --subject "Code Syncing Failure - $error_line: $error_command"
}
...
# relaunch dash app
./Automation/start-server.sh
aws sns publish --topic-arn arn:aws:sns:us-east-2:637423600104:F1-Visualizer --message file://./Automation/sync-code.log --subject "Code Syncing Success - $UTC"
